...
try:
    with sync_playwright() as pw:
        ...
        expect(page.locator('.vf-filter-done')).to_be_hidden()
        passed('desktop filters stay inline without mobile-only result action')
        ...
        expect(result_action).to_be_focused()
        page.keyboard.press('Tab')
        expect(first_filter).to_be_focused()
        result_action.click()
